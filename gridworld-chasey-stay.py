...
# gridworld setup and State object basics from
#MJeremy2017
...
class State:
    ...
    def chaseReward(self):
        if self.state[CHASE_IDX] == self.state[FLEE_IDX]:
            return 1
        #this elif sets up a 'thief' scenario
...
def write_video(states, board):
    ...
    video = VideoWriter('./chasey-vid-honey.avi',fourcc,float(FPS), 
									(width, height))
